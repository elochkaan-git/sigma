...
/**
 * @brief Структура с параметрами базы данных, необходимых для подключения к
 * этой базе данных.
 */
struct DatabaseInfo
{
 ...
 *
 * Данный класс необходим для управления соединениями с базой данных. Создается
 * в главном цикле программы единожды, а затем передается в виде указателя во
 * все репозитории.
 *
 * @see UserRepository
 */
